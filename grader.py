...
def test3a():
    ...
    mdp3 = submission.BlackjackMDP(cardValues=[1, 5, 7], multiplicity=3,
                                   threshold=15, peekCost=1)
    preEmptyState = (11, None, (1,0))

    # Make sure the succAndProbReward function is implemented correctly.
    tests = [
        ([((17, None, None),1,0)], mdp3, (12,1,(1,1,1)), 'Take'),
        ([((17,None,None),2/3,0), ((19,None,None),1/3,0)], mdp3, (12,None,(0,2,1)), 'Take'),
        ([((12,0,(1,3,0)),1/4,-1), ((12,1,(1,3,0)),3/4,-1)], mdp3, (12,None,(1,3,0)), 'Peek'),
...
def test4a():
    ...
    mdp.computeStates()
    rl = submission.QLearningAlgorithm(mdp.actions, mdp.discount(),submission.identityFeatureExtractor,0)
